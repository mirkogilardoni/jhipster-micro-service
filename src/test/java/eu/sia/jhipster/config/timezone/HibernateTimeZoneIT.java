package eu.sia.jhipster.config.timezone;
...
import eu.sia.jhipster.repository.timezone.DateTimeWrapper;
import eu.sia.jhipster.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
