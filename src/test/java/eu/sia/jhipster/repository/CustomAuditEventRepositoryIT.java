...
import static eu.sia.jhipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
import eu.sia.jhipster.config.audit.AuditEventConverter;
import eu.sia.jhipster.domain.PersistentAuditEvent;
